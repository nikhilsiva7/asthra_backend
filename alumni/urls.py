...
from .views import AlumniViewSet,JobBoardViewSet,ApplicationViewSet,SkillViewSet,MentorViewSet,ForumViewSet,FeedbackViewSet,AlumniRegisterView,AlumniLoginView
